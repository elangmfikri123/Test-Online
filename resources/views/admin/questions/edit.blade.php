...
<body class="font-poppins text-[#0A090B]">
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex items-center gap-5">
                            <div class="flex gap-[10px] items-center">
                                ...
                                <p class="font-semibold">{{ \Carbon\Carbon::parse($course->created_at)->translatedFormat('d F Y') }}</p>
                            </div>
                            <div class="flex gap-[10px] items-center">
                                <div class="w-6 h-6 flex shrink-0">
                                    <img src="{{ asset('images/icons/profile-2user-outline.svg')}}" alt="icon">
                                </div>
                                <p class="font-semibold">{{ count($students) }}  Participants</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form method="POST" action="{{ route('dashboard.course_question.update', $courseQuestion) }}" class="mx-[70px] mt-[30px] flex flex-col gap-5">
                @csrf
                @method('PUT')
